**LiveStats** is a small program running a Node JS backend and Python (or any MQTT-compatible language) front-end that allows for devices on a network to be monitored from a central point.\
